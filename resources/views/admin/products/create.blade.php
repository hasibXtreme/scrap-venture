...
<head>
    ...
    <title>Add New Product — ScrapVenture Admin</title>
    <!-- Google Fonts -->
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-8">
        <div class="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 sm:p-10 border border-slate-100 relative overflow-hidden">
            ...
            <div class="mb-8 border-b border-slate-100 pb-6">
                ...
                <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Add New Scrap Product</h1>
                <p class="text-slate-500 text-xs mt-1">Publish recyclable material rates and details for your eco network catalog.</p>
            </div>
            ...
            <form action="{{ route('admin.products.create') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="{{ old('category') }}" 
                            required 
                            placeholder="e.g. Metals, Plastics, Paper, Electronics"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 focus:bg-white transition"
                        >
                    </div>
                </div>
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                        Unit Rate / Price ($) <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="3" 
                        required 
                        placeholder="Provide details about material specifications, cleanliness criteria, or pickup terms..."
                        class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 focus:bg-white transition"
                ...
                <div>
                    ...
                    <div class="relative border-2 border-dashed border-slate-200 rounded-2xl p-6 hover:border-brand-500 transition-colors bg-slate-50/50 text-center">
                        <input 
                            type="file" 
                            name="image" 
                            accept="image/*" 
                        ...
                        <div id="upload-placeholder" class="flex flex-col items-center justify-center">
                            <div class="w-12 h-12 rounded-xl bg-brand-50 text-brand-600 flex items-center justify-center mb-2">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                </svg>
                            </div>
                            <p class="text-xs font-bold text-slate-700">Click to upload product image</p>
                            <p class="text-[11px] text-slate-400 mt-0.5">PNG, JPG, JPEG, WEBP up to 2MB</p>
                        </div>
                        <img id="image-preview" class="hidden max-h-40 mx-auto rounded-xl object-cover shadow-sm">
                    </div>
                </div>
